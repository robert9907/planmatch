...
const EMPTY_MEDICAL = {
  ...
  diagnostic_procedures: EMPTY_COST_SHARE,
  xray: EMPTY_COST_SHARE,
  advanced_imaging: EMPTY_COST_SHARE,
  mental_health_individual: EMPTY_COST_SHARE,
  mental_health_group: EMPTY_COST_SHARE,
  physical_speech_therapy: EMPTY_COST_SHARE,
  occupational_therapy: EMPTY_COST_SHARE,
  telehealth: EMPTY_COST_SHARE,
  ambulance: EMPTY_COST_SHARE,
  air_transportation: EMPTY_COST_SHARE,
  chiropractic: EMPTY_COST_SHARE,
  acupuncture: EMPTY_COST_SHARE,
  podiatry: EMPTY_COST_SHARE,
  substance_abuse: EMPTY_COST_SHARE,
  dme_prosthetics: EMPTY_COST_SHARE,
  partb_drugs: EMPTY_COST_SHARE,
  diabetic_supplies: EMPTY_COST_SHARE,
  insulin: EMPTY_COST_SHARE,
  home_health: EMPTY_COST_SHARE,
  renal_dialysis: EMPTY_COST_SHARE,
};
...
function p(override: PlanOverride): Plan {
  ...
  const defaultBenefits: Plan['benefits'] = {
    dental: { preventive: true, comprehensive: true, annual_max: 2000, description: null },
    vision: { exam: true, eyewear_allowance_year: 300, description: null },
    hearing: { aid_allowance_year: 2000, exam: true, description: null },
    transportation: { rides_per_year: 36, distance_miles: 60 },
    otc: { allowance_per_quarter: 185 },
    food_card: { allowance_per_month: 0, restricted_to_medicaid_eligible: true, description: null },
...
const PLANS: Plan[] = [
  ...
  p({
    ...
    star_rating: 4,
    benefits: {
      dental: { preventive: true, comprehensive: true, annual_max: 3000, description: null },
      vision: { exam: true, eyewear_allowance_year: 400 },
      hearing: { aid_allowance_year: 2500, exam: true, description: null },
      transportation: { rides_per_year: 48, distance_miles: 60 },
      otc: { allowance_per_quarter: 225 },
      food_card: { allowance_per_month: 160, restricted_to_medicaid_eligible: true, description: null },
  ...
  p({
    ...
    star_rating: 4,
    benefits: {
      dental: { preventive: true, comprehensive: true, annual_max: 2500, description: null },
      vision: { exam: true, eyewear_allowance_year: 350, description: null },
      hearing: { aid_allowance_year: 2000, exam: true, description: null },
      transportation: { rides_per_year: 36, distance_miles: 50 },
      otc: { allowance_per_quarter: 175 },
      food_card: { allowance_per_month: 140, restricted_to_medicaid_eligible: true, description: null },
  ...
  p({
    ...
    benefits: {
      ...
      food_card: { allowance_per_month: 125, restricted_to_medicaid_eligible: true, description: null },
      diabetic: { covered: true, preferred_brands: ['OneTouch', 'Accu-Chek'] },
      fitness: { enabled: true, program: 'SilverSneakers' },
    },
  ...
  p({
    ...
    star_rating: 4,
    benefits: {
      dental: { preventive: true, comprehensive: false, annual_max: 1500, description: null },
      vision: { exam: true, eyewear_allowance_year: 300, description: null },
      hearing: { aid_allowance_year: 1500, exam: true, description: null },
      transportation: { rides_per_year: 24, distance_miles: 60 },
      otc: { allowance_per_quarter: 150, description: null },
      food_card: { allowance_per_month: 100, restricted_to_medicaid_eligible: true, description: null },
      diabetic: { covered: true, preferred_brands: ['OneTouch'] },
      fitness: { enabled: true, program: 'Renew Active' },
    },
  ...
  p({
    ...
    benefits: {
      ...
      vision: { exam: true, eyewear_allowance_year: 250, description: null },
      hearing: { aid_allowance_year: 1500, exam: true, description: null },
      transportation: { rides_per_year: 60, distance_miles: 75 },
      otc: { allowance_per_quarter: 165 },
      food_card: { allowance_per_month: 150, restricted_to_medicaid_eligible: true, description: null },
      diabetic: { covered: true, preferred_brands: ['Accu-Chek'] },
      fitness: { enabled: true, program: 'SilverSneakers' },
    },
  ...
  p({
    ...
    benefits: {
      ...
      otc: { allowance_per_quarter: 200, description: null },
      food_card: { allowance_per_month: 0, restricted_to_medicaid_eligible: true, description: null },
      diabetic: { covered: true, preferred_brands: ['OneTouch'] },
      fitness: { enabled: true, program: 'SilverSneakers' },
    },
  ...
  p({
    ...
    benefits: {
      ...
      vision: { exam: true, eyewear_allowance_year: 200, description: null },
      hearing: { aid_allowance_year: 1000, exam: true, description: null },
      transportation: { rides_per_year: 0, distance_miles: 0 },
      otc: { allowance_per_quarter: 50, description: null },
      food_card: { allowance_per_month: 0, restricted_to_medicaid_eligible: false, description: null },
  ...
  p({
    ...
    benefits: {
      ...
      hearing: { aid_allowance_year: 2500, exam: true, description: null },
      transportation: { rides_per_year: 48, distance_miles: 60 },
      otc: { allowance_per_quarter: 250, description: null },
      food_card: { allowance_per_month: 180, restricted_to_medicaid_eligible: true, description: null },
      diabetic: { covered: true, preferred_brands: ['Accu-Chek'] },
      fitness: { enabled: true, program: 'SilverSneakers' },
    },
  ...
  p({
    ...
    benefits: {
      ...
      transportation: { rides_per_year: 36, distance_miles: 60 },
      otc: { allowance_per_quarter: 200, description: null },
      food_card: { allowance_per_month: 155, restricted_to_medicaid_eligible: true, description: null },
      diabetic: { covered: true, preferred_brands: ['Accu-Chek'] },
      fitness: { enabled: true, program: 'SilverSneakers' },
    },
  ...
  p({
    ...
    benefits: {
      ...
      food_card: { allowance_per_month: 120, restricted_to_medicaid_eligible: true, description: null },
      diabetic: { covered: true, preferred_brands: ['OneTouch'] },
      fitness: { enabled: true, program: 'SilverSneakers' },
    },
