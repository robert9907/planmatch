    ...
    <div className="flex flex-col" style={{ height: '100vh', background: 'var(--warm)' }}>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <main className="flex-1 overflow-y-auto" style={{ padding: 24 }}>
          <div className="pm-surface" style={{ padding: 24, maxWidth: 960 }}>
            <div
            ...
            <p style={{ color: 'var(--i2)', marginTop: 8, fontSize: 14 }}>
              Foundation shell is live. Step components land in Phase 4 — routing, state,
              theme, and notepad are wired and ready.
            </p>
            ...
            >
              <PhaseCard title="Theme" body="Night/day toggle persists to localStorage; every surface uses CSS variables." status="ready" />
              <PhaseCard title="Session store" body="Zustand covers client, meds, providers, notes, mode." status="ready" />
              <PhaseCard title="Notepad" body="Sliding 310px panel with 10-point quick-add." status="ready" />
              <PhaseCard title="Layout" body="Topbar · Sidebar · TabColumn shell." status="ready" />
              <PhaseCard title="API layer" body="Serverless functions in /api wired by vercel.json." status="next" />
              <PhaseCard title="Photo capture" body="Twilio SMS + Claude Vision — Phase 3 priority." status="next" />
            </div>
          </div>
        </main>
